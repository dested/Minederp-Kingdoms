...
try{
return loopThroughKingdom(KingdomsPlugin.wrapper.selectQuery("*","Kingdom",""));} catch (SQLException e) {
			e.printStackTrace();
		return null;}
}
								public void insert(){try{
KingdomsPlugin.wrapper.insertQuery("Kingdom","default,'"+ _KingdomName+"', '"+ _KingdomSpawn+"', '"+ _KingdomHeart+"', '"+ _KingdomHomePolygon+"'"  );
