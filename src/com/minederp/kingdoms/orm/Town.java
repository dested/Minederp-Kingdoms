...
return null;
								...
								public String getTownName(){ return _TownName; }
								public void setTownName(String aTownName){  if(aTownName==null || aTownName.equals("null")) return;  _TownName=aTownName; }
...
return null;
								...
								public String getTownSpawn(){ return _TownSpawn; }
								public void setTownSpawn(String aTownSpawn){  if(aTownSpawn==null || aTownSpawn.equals("null")) return;  _TownSpawn=aTownSpawn; }
...
return null;
								...
								public String getTownHeart(){ return _TownHeart; }
								public void setTownHeart(String aTownHeart){  if(aTownHeart==null || aTownHeart.equals("null")) return;  _TownHeart=aTownHeart; }
...
return null;
								...
								public KingdomPlayer getGovernor(){ return KingdomPlayer.getFirstByKingdomPlayerID(_GovernorID); }
								private int _GovernorID;
								public int getGovernorID(){ return _GovernorID; }
								public void setGovernorID(int aGovernorID){   _GovernorID=aGovernorID; }
...
return null;
								...
								public String getTownPolygon(){ return _TownPolygon; }
								public void setTownPolygon(String aTownPolygon){  if(aTownPolygon==null || aTownPolygon.equals("null")) return;  _TownPolygon=aTownPolygon; }
...
try{
return loopThroughTown(KingdomsPlugin.wrapper.selectQuery("*","Town",""));} catch (SQLException e) {
			e.printStackTrace();
		return null;}
}
								public void insert(){try{
KingdomsPlugin.wrapper.insertQuery("Town","default,'"+ _TownName+"', '"+ _TownSpawn+"', '"+ _TownHeart+"', "+ _KingdomID+", "+ _GovernorID+", '"+ _TownPolygon+"'"  );
			...
			e.printStackTrace();
								...
								public void update(){ 
try{
KingdomsPlugin.wrapper.updateQuery("UPDATE Town SET TownName= '"+ _TownName+"' , TownSpawn= '"+ _TownSpawn+"' , TownHeart= '"+ _TownHeart+"' , KingdomID= "+ _KingdomID+" , GovernorID= "+ _GovernorID+" , TownPolygon= '"+ _TownPolygon+"' where TownID="+_TownID+" ");
} catch (SQLException e) {
			e.printStackTrace();
		}
}
