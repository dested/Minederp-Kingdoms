...
public class KingdomPlayer {
	...
	public int getKingdomPlayerID() {
		return _KingdomPlayerID;
	}

	public void setKingdomPlayerID(int aKingdomPlayerID) {
		_KingdomPlayerID = aKingdomPlayerID;
	}

	public static List<KingdomPlayer> getAllByKingdomPlayerID(int aKingdomPlayerID) {

		try {
			return loopThroughKingdomPlayer(KingdomsPlugin.wrapper
					.selectQuery("*", "KingdomPlayer", "where KingdomPlayerID=" + aKingdomPlayerID + ""));
	...
	public static List<KingdomPlayer> getAllByPlayerNickName(String aPlayerNickName) {
		...
		try {
			return loopThroughKingdomPlayer(KingdomsPlugin.wrapper
					.selectQuery("*", "KingdomPlayer", "where PlayerNickName='" + aPlayerNickName + "'"));
	...
	public static List<KingdomPlayer> getAll() {
		try {
			return loopThroughKingdomPlayer(KingdomsPlugin.wrapper.selectQuery("*", "KingdomPlayer", ""));
		} catch (SQLException e) {
			e.printStackTrace();
			return null;
		}
	...
	public void insert() {
		try {
			KingdomsPlugin.wrapper.insertQuery("KingdomPlayer", "default,'" + _PlayerName + "', '" + _PlayerNickName + "', " + _KingdomID + ", "
					+ _TownID + "");
	...
	public void update() {
		try {
			KingdomsPlugin.wrapper.updateQuery("UPDATE KingdomPlayer SET PlayerName= '" + _PlayerName + "' , PlayerNickName= '" + _PlayerNickName
					+ "' , KingdomID= " + _KingdomID + " , TownID= " + _TownID + " where KingdomPlayerID=" + _KingdomPlayerID + " ");
		} catch (SQLException e) {
			e.printStackTrace();
		}
	}
