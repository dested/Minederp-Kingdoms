...
return null;
								...
								public void setPlayerName(String aPlayerName){ _PlayerName=aPlayerName; }
...
return null;
								...
								public void setPlayerNickName(String aPlayerNickName){ _PlayerNickName=aPlayerNickName; }
...
KingdomsPlugin.wrapper.insertQuery("KingdomPlayer","default,'"+ _PlayerName+"', '"+ _PlayerNickName+"', "+ _KingdomID+", "+ _TownID+""  );
			...
			e.printStackTrace();
								...
								public void update(){ 
try{
KingdomsPlugin.wrapper.updateQuery("UPDATE KingdomPlayer where KingdomPlayerID="+_KingdomPlayerID+" SET PlayerName= '"+ _PlayerName+"' , PlayerNickName= '"+ _PlayerNickName+"' , KingdomID= "+ _KingdomID+" , TownID= "+ _TownID+"");
} catch (SQLException e) {
			e.printStackTrace();
		}
}
